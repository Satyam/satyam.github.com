...
?>
			...
			<p>Known isues:</p>
			<ul>
				<li>The height of the bars are fixed.  On a small container, they may overflow the allotted space.</li>
				<li>The first time the extended description pops up, it is slightly lower than it should.</li>
				<li>I should add the dates to the 'title' attribute so that placing the cursor over a bar will show its extent.</li>
				...
				<li>Hidden categories are ignored.  This is trivial, but I keep forgetting because I don't write it down, so now I did write it down, there is hope</li>
			</ul>
