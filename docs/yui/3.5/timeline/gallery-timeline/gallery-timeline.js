...
Y.Timeline = Y.Base.create(
	...
	[],
	{
		...
		_locate: function () {
			...
			console.log(highest, lowest, middle, mode);
...
}, '@VERSION@' ,{skinnable:true, optional:['intl'], lang:['en', 'es'], requires:['node', 'io-base', 'base', 'event-mousewheel', 'event-gestures', 'classnamemanager', 'datatype']});
