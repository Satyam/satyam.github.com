...
Olivetti había sido pionera en el desarrollo y comercialización de sistemas informáticos, ofreciendo desde grandes computadoras (un negocio que luego vendió a General Electric) hasta la primera computadora programable de escritorio, la [Programma 101](https://es.wikipedia.org/wiki/Programma_101).  No participó en el desarrollo de las primeras computadoras, aquellas que eran únicas y recibían nombres propios, y que eran tanto herramientas de cálculo como objetos de estudio en las grandes universidades, pero sí diseño computadoras como productos comercializables, con el característico diseño italiano que marcaba al resto de sus productos.
